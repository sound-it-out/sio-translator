...
{
    public class WhenDocumentUploadedEventIsSuppliedAndIsAWSTranslation : AWSTranslationSpecification
    {
        public WhenDocumentUploadedEventIsSuppliedAndIsAWSTranslation(AWSTranslationFixture awsTranslationFixture, DocumentUploadedFixture eventFixture) : base(awsTranslationFixture, eventFixture, TranslationType.AWS)
        {
        }

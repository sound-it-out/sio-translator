...
{
    public class WhenDocumentUploadedEventIsSuppliedAndIsMicrosoftTranslation : AWSTranslationSpecification
    {
        public WhenDocumentUploadedEventIsSuppliedAndIsMicrosoftTranslation(AWSTranslationFixture awsTranslationFixture, DocumentUploadedFixture eventFixture) : base(awsTranslationFixture, eventFixture, TranslationType.Microsoft)
        {
        }

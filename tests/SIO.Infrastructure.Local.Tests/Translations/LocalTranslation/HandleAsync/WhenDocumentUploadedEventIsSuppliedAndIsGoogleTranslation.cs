...
{
    public class WhenDocumentUploadedEventIsSuppliedAndIsGoogleTranslation : LocalTranslationSpecification, IClassFixture<LocalTranslationFixture>, IClassFixture<DocumentUploadedFixture>
    {
        public WhenDocumentUploadedEventIsSuppliedAndIsGoogleTranslation(LocalTranslationFixture localTranslationFixture, DocumentUploadedFixture eventFixture) : base(localTranslationFixture, eventFixture, TranslationType.Google)
        {
        }

...
{
    public class WhenDocumentUploadedEventIsSuppliedAndIsMicrosoftTranslation : LocalTranslationSpecification
    {
        public WhenDocumentUploadedEventIsSuppliedAndIsMicrosoftTranslation(LocalTranslationFixture localTranslationFixture, DocumentUploadedFixture eventFixture) : base(localTranslationFixture, eventFixture, TranslationType.Microsoft)
        {
        }

...
{
    public class WhenTranslationFails : GoogleTranslationWorkerSpecification
    {
        ...
        protected override void BuildServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<ISpeechSynthesizer<GoogleSpeechRequest>>(new InMemoryGoogleSpeechSynthesizer(true));
        }

...
{
    public class WhenDocumentUploadedEventIsSuppliedAndIsAWSTranslation : GoogleTranslationSpecification, IClassFixture<GoogleTranslationFixture>, IClassFixture<DocumentUploadedFixture>
    {
        public WhenDocumentUploadedEventIsSuppliedAndIsAWSTranslation(GoogleTranslationFixture googleTranslationFixture, DocumentUploadedFixture eventFixture) : base(googleTranslationFixture, eventFixture, TranslationType.AWS)
        {
        }

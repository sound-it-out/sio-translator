...
{
    public class WhenDocumentUploadedEventIsSuppliedAndIsGoogleTranslation : GoogleTranslationSpecification
    {
        public WhenDocumentUploadedEventIsSuppliedAndIsGoogleTranslation(GoogleTranslationFixture googleTranslationFixture, DocumentUploadedFixture eventFixture) : base(googleTranslationFixture, eventFixture, TranslationType.Google)
        {
        }
